...
if __name__ == '__main__':
    ...
    out_video_file = os.path.join(args.save_dir, f'{video_name}_output.mp4')
    ...
    player_detect = player_tracker.detect_player(bytetrack_input_frames, last_detect=False, path_of_last_detect="yolo_last_detect/list_player_dict")
    player_bbox = player_tracker.draw_player_bbox(bytetrack_input_frames, player_detect)
    
    output_video_path = "prediction/tracknet_bytetrack_output.mp4"
    save_video(player_bbox, out_video_file, output_video_path)
